...
if (getDolGlobalString('MAIN_ONLY_LOGIN_ALLOWED')) {
	...
	if (!$ok) {
		if (session_id() && isset($_SESSION["dol_login"]) && $_SESSION["dol_login"] != $conf->global->MAIN_ONLY_LOGIN_ALLOWED) {
			...
			print 'Vous êtes connecté en tant que "'.$_SESSION["dol_login"].'" et seul l\'administrateur "'.$conf->global->MAIN_ONLY_LOGIN_ALLOWED.'" est autorisé à se connecter pour le moment.'."\n";
			...
			print 'Désolé, votre application est hors ligne pour maintenance. Seul l\'administrateur "'.$conf->global->MAIN_ONLY_LOGIN_ALLOWED.'" est autorisé à se connecter pour le moment.'."\n";
