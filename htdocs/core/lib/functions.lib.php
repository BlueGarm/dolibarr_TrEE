	...
	if ($pictoisfullpath) {
		...
		if (empty($srconly) && in_array($pictowithouttext, array(
			...
			$arrayconvpictotofa = array(
				...
				'knowledgemanagement' => 'question-circle', 'label' => 'layer-group', 'line' => 'bars', 'loan' => 'money-bill-alt', // Modification : Changemement Icône FAQ
				...
				'other' => 'square',
				'playdisabled' => 'play', 'pdf' => 'file-pdf', 'poll' => 'check-double', 'pos' => 'cash-register', 'preview' => 'binoculars', 'project' => 'piggy-bank', 'projectpub' => 'project-diagram', 'projecttask' => 'tasks', 'propal' => 'file-signature', 'proposal' => 'file-signature', // Modification : Changement icone projet
			...
			if (in_array($pictowithouttext, array('asset', 'intervention', 'payment', 'loan', 'partnership', 'stock', 'technic'))) {
				$morecss .= ' em080';
			}*/ // Modification : Désactivation taille icônes
