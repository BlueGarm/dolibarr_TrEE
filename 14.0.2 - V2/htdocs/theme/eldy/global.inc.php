...
#mainbody input.button:not(.buttongen):not(.bordertransp), #mainbody a.button:not(.buttongen):not(.bordertransp) {
	...
	color: #444 !important; /* Changement Couleurs #FFF to #444 */
	border-radius: 3px;
...
span.amount.more100percent, span.amount.negatif {
	color: red;
}
td.actionbuttons a {
	padding-left: 6px;
...
.boxtable > tbody.scrollable {
    display:block;
    max-height:362px;
    overflow-y:auto;
}

.boxtable > thead.scrollable, .boxtable > tbody.scrollable tr {
    display:table;
    width:100%;
    table-layout:fixed;
}
