...
class Project extends CommonObject
{
	...
	public $fields = array(
		...
		'budget_amount' =>array('type'=>'double(24,8)', 'label'=>'Budget', 'enabled'=>1, 'visible'=>1, 'position'=>119), // Modification : Budget
		'budget_rest' =>array('type'=>'double(24,8)', 'label'=>'BudgetRestant', 'enabled'=>1, 'visible'=>1, 'position'=>12), // Modification : Budget Restant
		'budget_percent' =>array('type'=>'decimal(9,2)', 'label'=>'PercentUtilisation', 'enabled'=>1, 'visible'=>1, 'position'=>13),  // Modification : Budget Pourcentage
	...
	public function create($user, $notrigger = 0)
	{
		...
		// Modification : Budget Restant
		$sql .= ", ".(strcmp($this->budget_rest, '') ? price2num($this->budget_rest) : 'null');
		$sql .= ", ".(strcmp($this->budget_percent, '') ? $this->budget_rest : 'null');
	...
	public function update($user, $notrigger = 0)
	{
		...
		if (dol_strlen(trim($this->ref)) > 0) {
			...
			// Modification : Budget Restant
			$sql .= ", budget_rest = ".(strcmp($this->budget_rest, '') ? price2num($this->budget_rest) : "null");
			$sql .= ", budget_percent = ".($this->budget_percent ? $this->budget_percent : "null");
	...
	public function fetch($id, $ref = '', $ref_ext = '', $email_msgid = '')
	{
		...
		$sql = "SELECT rowid, entity, ref, title, description, public, datec, opp_amount, budget_amount, budget_rest, budget_percent,"; // Modification : Budget Restant
		...
		if ($resql) {
			...
			if ($num_rows) {
				...
				// Modification : Budget Restant
				$this->budget_rest = $obj->budget_rest;
				$this->budget_percent = $obj->budget_percent;
