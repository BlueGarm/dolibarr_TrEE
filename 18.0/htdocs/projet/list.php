...
// Modification : Budget Restant [583-589]
...
// Modification : Budget Restant [884-890]
if ($search_budget_rest != '') {
...
if (!empty($arrayfields['p.budget_amount']['checked'])) {
	print '<td class="liste_titre nowrap right">';
	// Modification : Budget Restant [1186-1197]
