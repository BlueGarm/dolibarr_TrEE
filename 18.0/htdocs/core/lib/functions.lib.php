	...
	if ($pictoisfullpath) {
		...
		if (empty($srconly) && in_array($pictowithouttext, array(
			...
			$arrayconvpictotofa = array(
				...
				'other'=>'square',
				'playdisabled'=>'play', 'pdf'=>'file-pdf',  'poll'=>'check-double', 'pos'=>'cash-register', 'preview'=>'binoculars', 'project'=>'piggy-bank', 'projectpub'=>'project-diagram', 'projecttask'=>'tasks', 'propal'=>'file-signature', // Modification : Changement icone projet
