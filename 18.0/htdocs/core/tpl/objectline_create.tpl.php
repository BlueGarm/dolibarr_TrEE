...
?>
	...
	function setforpredef() {
		...
		jQuery("#options_cnacre, .commande_fournisseurdet_extras_cnacre, .commande_fournisseurdet_extras_add_bdd").hide(); // Modification : Masquage code NACRE et Ajout BDD sur produit prédéfinie
	}
