...
class ExtraFields
{
	...
	public function showSeparator($key, $object, $colspan = 2, $display_type = 'card', $mode = '')
	{
		...
		// Output the picto
		$out .= '<span class="cursorpointer '.($extrafield_collapse_display_value == 0 ? 'fas fa-angle-right opacitymedium' : 'far fa-'.(($expand_display ? 'minus' : 'plus').'-square')).'"></span>'; // Modification : Remplacement puce 
		$out .= '&nbsp;';
		$out .= '<strong>';
