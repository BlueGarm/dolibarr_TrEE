	...
	public function getDocumentsLink($modulepart, $modulesubdir, $filedir, $filter = '', $morecss = 'valignmiddle', $allfiles = 0)
	{
		...
		if (!empty($file_list)) {
			$out = '<dl class="dropdown inline-block">
    			...
    			<dd><div class="multichoicedoc" style="position:absolute;" ><ul class="ulselectedfields" style="position:absolute; right: unset!important; left: -100px!important;">'; // Modification : Affichage correct ul
			$tmpout = '';
