...
class Project extends CommonObject
{
	...
	public $fields = array(
		...
		'budget_rest' =>array('type'=>'double(24,8)', 'label'=>'BudgetRestant', 'enabled'=>1, 'visible'=>1, 'position'=>11),																									   
	...
	public function fetch($id, $ref = '', $ref_ext = '', $email_msgid = '')
	{
		...
		$sql = "SELECT rowid, entity, ref, title, description, public, datec, opp_amount, budget_amount, budget_rest";
