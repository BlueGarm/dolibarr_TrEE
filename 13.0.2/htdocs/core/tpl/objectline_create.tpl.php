...
?>
	...
	function setforfree() {
		...
		jQuery("#price_ht, #multicurrency_price_ht, #price_ttc, #price_ttc, #fourn_ref, #tva_tx, #buying_price, #title_fourn_ref, #title_vat, #title_up_ht, #title_up_ht_currency, #title_up_ttc, #title_up_ttc_currency, #options_cnacre, #options_add_bdd").show();
	...
	function setforpredef() {
		...
		<?php } ?>
		jQuery("#price_ttc, #fourn_ref, #tva_tx, #title_fourn_ref, #title_vat, #title_up_ttc, #title_up_ttc_currency, #options_cnacre, #options_add_bdd").hide();
