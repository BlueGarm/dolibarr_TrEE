...
.titlefieldcreate { width: /* 20%;*/ 175px } /* Modification  : Taille Titre Extrafields */
...
@media only screen and (max-width: 1400px)
{
	...
	.titlefieldcreate { width: /*50%*/175px!important; } /* Modification : Affiche en ligne titre extrafields */
	.minwidth50imp  { min-width: 50px !important; }
	.minwidth75imp  { min-width: 75px !important; }
	.minwidth100imp { min-width: 100px !important; }
...
/* Modification : Uniformisation message sous login */
.login_main_home {
	word-break: break-word;
