...
class Project extends CommonObject
{
	...
	public $fields = array(
		...
		'budget_rest' =>array('type'=>'double(28,4)', 'label'=>'BudgetRestant', 'enabled'=>1, 'visible'=>1, 'position'=>12),
		// Modification : Budget Restant
		'budget_percent' =>array('type'=>'decimal(9,2)', 'label'=>'PercentUtilisation', 'enabled'=>1, 'visible'=>1, 'position'=>13),
	...
	public function fetch($id, $ref = '', $ref_ext = '', $email_msgid = '')
	{
		...
		$sql = "SELECT rowid, entity, ref, title, description, public, datec, opp_amount, budget_amount, budget_rest, budget_percent,"; // Modification : Budget Resta t
